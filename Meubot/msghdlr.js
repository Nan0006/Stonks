...
*/
				...
				case 'usarpoçao':
					...
					const tiroa = ["vive","morreu","vive","morreu","vive","morreu","vive","morreu","morreu","morreu","vive","vive"]
...
*/ 
			...
			teks = `${dopwioqae} *${akuuioqae.jid.split('@')[0]}*\n`
			jds.push(akuuioqae.jid)
			mentions(teks, jds, true)
			}, 900000)
		    } else if (args[0] === 'desativar') {
			var poiinte = clearInterval( (ponte) => {
			client.updatePresence(Presence.composing)
			reply('Chamar desativar')
			}, 10000)
			}
				break
			case 'membros':
